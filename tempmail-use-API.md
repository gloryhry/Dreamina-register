...
curl https://moemail.985100.xyz/api/config \
  -H "X-API-Key: YOUR_API_KEY"

## 生成临时邮箱

curl -X POST https://moemail.985100.xyz/api/emails/generate \
  -H "X-API-Key: YOUR_API_KEY" \
...
curl https://moemail.985100.xyz/api/emails?cursor=CURSOR \
  -H "X-API-Key: YOUR_API_KEY"

## 获取邮件列表

curl https://moemail.985100.xyz/api/emails/{emailId}?cursor=CURSOR \
  -H "X-API-Key: YOUR_API_KEY"

## 获取单封邮件

curl https://moemail.985100.xyz/api/emails/{emailId}/{messageId} \
  -H "X-API-Key: YOUR_API_KEY"
